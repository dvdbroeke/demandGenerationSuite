...
const crossElasticities: XElasticity[] = [
  ...
  { from: "Brand C Orange 330ml", to: "Brand D 330ml", elasticity: -0.20 },
  { from: "Brand C Orange 330ml", to: "Competitor Y (Comp)", elasticity: -0.15 },
  { from: "Brand C Orange 500ml", to: "Brand C Orange 330ml", elasticity: -0.18 },
  { from: "Brand C Orange 2L", to: "Brand C Orange 500ml", elasticity: -0.24 },
  { from: "Brand C Orange 2L", to: "Competitor Z 2L (Comp)", elasticity: -0.20 },
  { from: "Brand D 330ml", to: "Brand C Orange 330ml", elasticity: -0.18 },
  { from: "Brand D 500ml", to: "Brand C Orange 500ml", elasticity: -0.22 },
