...
const priceTiers: PriceTier[] = [
  ...
  { tier: "Mainstream (\u20ac1.00-\u20ac1.29)", rangeMin: 1.00, rangeMax: 1.29, skuCount: 4, skus: ["Brand C 330ml (\u20ac1.19)","Brand D 330ml (\u20ac1.25)","Brand B 330ml (\u20ac1.29)","Brand A Classic 330ml (\u20ac1.35)"], shareOfShelf: 35, revShare: 32, status: "Crowded", insight: "4 SKUs competing within \u20ac0.16 band -- high internal overlap. Brand A Classic & Brand B at parity encourages unintended switching" },
  { tier: "Mid (\u20ac1.30-\u20ac1.69)", rangeMin: 1.30, rangeMax: 1.69, skuCount: 5, skus: ["Brand A Zero 330ml (\u20ac1.39)","Brand C 500ml (\u20ac1.65)","Brand D 500ml (\u20ac1.69)","Brand C 1.5L (\u20ac1.79)","Brand B 500ml (\u20ac1.79)"], shareOfShelf: 22, revShare: 24, status: "Balanced", insight: "Adequate coverage -- Brand A Zero well-positioned as trading-up option from Mainstream. Brand C 500ml underperforms at this tier" },
  { tier: "Upper Mid (\u20ac1.70-\u20ac1.99)", rangeMin: 1.70, rangeMax: 1.99, skuCount: 5, skus: ["Brand A Classic 500ml (\u20ac1.89)","Brand D 2L (\u20ac1.89)","Brand A Zero 500ml (\u20ac1.95)","Brand B 1.5L (\u20ac1.99)","Brand A Classic 1.5L (\u20ac2.15)"], shareOfShelf: 28, revShare: 26, status: "Crowded", insight: "5 SKUs in tight range. Brand B 1.5L & Brand D 2L weakest performers -- 2L PET cannibalised by 1.5L at similar price point" },
  { tier: "Take Home (\u20ac2.00-\u20ac2.29)", rangeMin: 2.00, rangeMax: 2.29, skuCount: 4, skus: ["Brand A Zero 1.5L (\u20ac2.19)","Brand A Classic 2L (\u20ac2.19)","Brand A Zero 2L (\u20ac2.15)","Brand A Classic 1.5L (\u20ac2.15)"], shareOfShelf: 12, revShare: 14, status: "Balanced", insight: "Take-home tier is well-spaced, but Brand A Zero 2L at only 58% distribution represents an expansion opportunity" },
  { tier: "Multipack (>\u20ac3.50)", rangeMin: 3.50, rangeMax: 5.00, skuCount: 2, skus: ["Brand A Classic 6x330ml (\u20ac4.00)","Brand A Zero 6x330ml (\u20ac4.20)"], shareOfShelf: 8, revShare: 12, status: "Gap", insight: "Only 2 multipack SKUs -- whitespace for Brand D/Brand C 6x330ml or 12-pack formats to capture \u20ac3.2M bulk-buy occasion" },
]
...
const crossElasticities: XElasticity[] = [
  { from: "Brand A Classic 330ml", to: "Brand A Zero 330ml", elasticity: -0.22 },
  { from: "Brand A Classic 330ml", to: "Brand B 330ml", elasticity: -0.15 },
  { from: "Brand A Classic 330ml", to: "Competitor X 330ml", elasticity: -0.35 },
  { from: "Brand A Classic 500ml", to: "Brand A Classic 330ml", elasticity: -0.18 },
  { from: "Brand A Classic 500ml", to: "Brand A Classic 1.5L", elasticity: -0.14 },
  { from: "Brand A Classic 500ml", to: "Competitor X 500ml", elasticity: -0.30 },
  { from: "Brand A Classic 1.5L", to: "Brand A Classic 2L", elasticity: -0.32 },
  { from: "Brand A Classic 2L", to: "Brand A Classic 1.5L", elasticity: -0.28 },
  { from: "Brand A Classic 2L", to: "Competitor X 2L", elasticity: -0.38 },
  { from: "Brand A Classic 6x330ml", to: "Brand A Classic 330ml", elasticity: -0.24 },
  { from: "Brand A Classic 6x330ml", to: "Competitor X 6-pack", elasticity: -0.32 },
  { from: "Brand A Zero 330ml", to: "Brand B 330ml", elasticity: -0.42 },
  { from: "Brand A Zero 330ml", to: "Brand A Classic 330ml", elasticity: -0.12 },
  { from: "Brand A Zero 330ml", to: "Competitor X Max 330ml", elasticity: -0.28 },
  { from: "Brand A Zero 500ml", to: "Brand B 500ml", elasticity: -0.32 },
  { from: "Brand A Zero 1.5L", to: "Brand A Classic 1.5L", elasticity: -0.22 },
  { from: "Brand A Zero 2L", to: "Brand A Zero 1.5L", elasticity: -0.26 },
  { from: "Brand A Zero 2L", to: "Brand A Classic 2L", elasticity: -0.18 },
  { from: "Brand A Zero 6x330ml", to: "Brand A Zero 330ml", elasticity: -0.20 },
  { from: "Brand A Zero 6x330ml", to: "Brand A Classic 6x330ml", elasticity: -0.15 },
  { from: "Brand B 330ml", to: "Brand A Zero 330ml", elasticity: -0.38 },
  { from: "Brand B 330ml", to: "Competitor X Max 330ml", elasticity: -0.25 },
  { from: "Brand B 500ml", to: "Brand A Zero 500ml", elasticity: -0.32 },
  { from: "Brand B 500ml", to: "Brand A Classic 500ml", elasticity: -0.10 },
  { from: "Brand B 1.5L", to: "Brand A Zero 1.5L", elasticity: -0.30 },
  { from: "Brand B 1.5L", to: "Brand A Classic 1.5L", elasticity: -0.16 },
  { from: "Brand D Orange 330ml", to: "Brand C 330ml", elasticity: -0.20 },
  { from: "Brand D Orange 330ml", to: "Brand D (Comp)", elasticity: -0.15 },
  { from: "Brand D Orange 500ml", to: "Brand D Orange 330ml", elasticity: -0.18 },
  { from: "Brand D Orange 2L", to: "Brand D Orange 500ml", elasticity: -0.24 },
  { from: "Brand D Orange 2L", to: "Mirinda 2L (Comp)", elasticity: -0.20 },
  { from: "Brand C 330ml", to: "Brand D Orange 330ml", elasticity: -0.18 },
  { from: "Brand C 500ml", to: "Brand D Orange 500ml", elasticity: -0.22 },
  { from: "Brand C 1.5L", to: "Brand C 500ml", elasticity: -0.16 },
  { from: "Brand C 1.5L", to: "7Up 1.5L (Comp)", elasticity: -0.28 },
]
...
const aiInsights = [
  ...
  { icon: AlertTriangle, color: "text-amber-400", bg: "bg-amber-500/10", text: "Mainstream tier is over-crowded: 4 SKUs within \u20ac0.10. Brand A Classic 330ml and Brand B 330ml at identical \u20ac1.29 creates -0.15 cross-elasticity. Recommend \u20ac0.10 separation." },
  { icon: Layers, color: "text-purple-400", bg: "bg-purple-500/10", text: "Multipack tier is severely under-represented: only Brand A Classic & Brand A Zero 6x330ml. Brand D/Brand C 6x330ml or 12-pack formats would capture \u20ac3.2M addressable bulk-buy occasion." },
  { icon: TrendingUp, color: "text-emerald-400", bg: "bg-emerald-500/10", text: "Cross-elasticity shows Brand B \u2192 Brand A Zero substitution is -0.42, the strongest internal pair. Pricing Brand B \u20ac0.10 below Brand A Zero would reduce cannib by ~8pp and protect both tiers." },
]
