...
const advisoryInitiatives = [
  {
    ...
    rationale: "Only 2 multipack SKUs (Brand A & Brand B) currently exist. Competitor X has 4 multipack variants. Bulk-buy occasion is growing +5% YoY and we have zero Brand C/Brand D presence.",
  ...
  },
  {
    ...
    actions: [
      ...
      "Co-promote with Brand B in 'Zero Sugar Range' shelf blocking strategy",
    ],
    rationale: "Zero-sugar segment growing +12% YoY. Brand B is well-positioned but Brand C Zero and Brand D Zero are absent in small formats. Cross-elasticity with sugared variants is only -0.08 to -0.12, meaning 85%+ incremental volume.",
  ...
  },
  {
    ...
    actions: [
      ...
      "Launch Brand B 150ml glass for premium meal pairing occasion",
    ...
    rationale: "Only Brand A 150ml glass exists in premium single-serve. Competitor Y has 6 premium SKUs in this space. Premium occasion is under-served with 65% coverage vs 92% for on-the-go.",
