...
const advisoryInitiatives = [
  {
    id: "adv-1",
    title: "Launch Fanta & Sprite Multipack Range",
    ...
    actions: [
      "Submit Fanta 6x330ml and Sprite 6x330ml to Esselunga, Conad, Coop Italia range reviews",
    ...
    rationale: "Only 2 multipack SKUs (CC Classic & CC Zero) currently exist. Competitor Pepsi has 4 multipack variants. Bulk-buy occasion is growing +5% YoY and we have zero Fanta/Sprite presence.",
  ...
  },
  {
    ...
    actions: [
      "Create Fanta 330ml PMP at \u20ac0.89 and Sprite 330ml PMP at \u20ac0.89",
      "List in Eurospin, Lidl, and bottom-tier convenience stores",
  ...
  },
  {
    ...
    status: "Recommended" as const,
    actions: [
      "Launch Fanta Zero 330ml and Sprite Zero 330ml in convenience and MT",
      "Add Fanta Zero 500ml for on-the-go health-conscious occasion",
      "Position at +\u20ac0.05 vs sugared variants to capture health premium",
      "Co-promote with CC Zero in 'Zero Sugar Range' shelf blocking strategy",
    ],
    rationale: "Zero-sugar segment growing +12% YoY. CC Zero is well-positioned but Fanta Zero and Sprite Zero are absent in small formats. Cross-elasticity with sugared variants is only -0.08 to -0.12, meaning 85%+ incremental volume.",
  ...
  },
  {
    ...
    actions: [
      ...
      "Propose delist of Sprite 500ml, Diet Coke 1.5L, and Fanta 2L in bottom 30% stores",
  ...
  {
    id: "adv-5",
    title: "Premium Single-Serve Expansion for Fanta",
    ...
    status: "Recommended" as const,
    actions: [
      "Launch Fanta 250ml glass bottle for on-premise and premium convenience",
      "Launch CC Zero 150ml glass for premium meal pairing occasion",
    ...
    rationale: "Only CC Classic 150ml glass exists in premium single-serve. San Pellegrino has 6 premium SKUs in this space. Premium occasion is under-served with 65% coverage vs 92% for on-the-go.",
