...
const initiatives: Initiative[] = [
  {
    id: "1",
    name: "Shift Media Investment from Brand B to Brand A Zero - Region 1",
    linkedPartition: "Category A - Zero Variant",
    linkedBrand: "Brand A Zero",
    linkedCountry: "Region 1",
    status: "draft",
    owner: "Enterprise",
    keyStakeholders: ["Media Director Region 1", "Brand Manager Brand A Zero", "Partner Marketing Lead"],
  ...
  {
    id: "3",
    name: "Improve Perceived Affordability of Brand A Zero Large Format",
