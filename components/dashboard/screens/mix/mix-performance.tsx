...
const aiInsights = [
  ...
  { icon: Sparkles, color: "text-blue-400", bg: "bg-blue-500/10", text: "Brand A and Brand B single-serve show 8-15% growth with premium PPL. These are the strongest mix-upgrade candidates: promoting single-serve in convenience drives +0.8pp premium mix shift." },
]
