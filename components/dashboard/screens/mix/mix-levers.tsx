...
const mixLevers = [
  ...
  },
  {
    ...
    actions: [
      { action: "Expand CC Zero 330ml to 85% WD in convenience (from 72%)", impact: "+1.2pp convenience volume" },
  ...
  },
  {
    ...
    description: "Drive consumers from Fanta/Sprite towards CC Classic/CC Zero for higher revenue per transaction",
    currentState: "CC brands are 62% of revenue; Fanta/Sprite at 38% with lower PPL",
    targetState: "CC brands to 66% of revenue through targeted activation",
    impactOnPPL: "+\u20ac0.06/L",
    impactOnGP: "+\u20ac0.4M",
    impactOnMix: "+0.8pp Premium",
    difficulty: "Low" as const,
    actions: [
      { action: "Co-promote CC Zero with CC Classic as 'taste upgrade' bundle", impact: "+0.4pp CC volume share" },
      { action: "Increase CC Zero media spend by 20% in digital", impact: "+0.3pp trial rate for health-conscious segment" },
      { action: "Position CC Classic premium glass in impulse zone", impact: "+\u20ac0.15/unit margin uplift" },
    ],
  },
  {
...
const aiInsights = [
  ...
  { icon: AlertTriangle, color: "text-amber-400", bg: "bg-amber-500/10", text: "Channel Mix is the highest-impact lever long-term but requires distribution investment. Start with convenience expansion for CC Zero 330ml which has proven velocity at 85%+ stores." },
